...
export const LOWLEVEL_CHAPTERS: Section[] = [
  ...
  },
  {
    id: 'dns',
    title: '第10章　名前を引く',
    summary: 'ほぼすべての通信は、名前を引くところから始まる。ゾーンと委任、メッセージの形、レコードの種類、アプリの中の名前解決、キャッシュと TTL、偽の答えと盗み見への対策、そして DNS が原因で起きる障害',
  },
  {
    id: 'db',
    title: '第11章　データベースの中身',
    summary: 'ここまでの部品で、データベースは組み上がっている。ページとバッファプール、プライマリとセカンダリの索引、WAL と MVCC、そしてそれを分散させた NewSQL',
  },
  {
    id: 'browser',
    title: '第12章　ブラウザの中身',
    summary: 'ブラウザは、ここまでの部品をすべて使う大きなプログラム。URL を打ってから最初のバイトが届くまで、プロセスの分け方、HTML の構文解析、レンダリングパイプラインと合成、イベントループ、JavaScript エンジン、そして Web Vitals が測っているもの',
  },
  {
    id: 'ffi',
    title: '第13章　言語の壁を越える',
